...
function onOpen() {
  ...
  ui.createMenu("Pokémon Cards 🃏")
    ...
    .addItem("💷 Refresh Prices (Owned Only - PokemonTCG)", "refreshPricesOwnedOnlyPokemonTCG")
    .addItem("💷 Refresh Prices (All - PokemonTCG)", "refreshPricesAllPokemonTCG")
    .addItem("💷 Refresh Prices (Owned Only - eBay)", "refreshPricesOwnedOnlyEbay")
    .addItem("💷 Refresh Prices (All - eBay)", "refreshPricesAllEbay")
